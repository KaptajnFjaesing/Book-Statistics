...
\begin{definition}[Robot]
	\label{def:robot}
	The Robot is the primary decision maker in the statistical game.\index{Robot}
\end{definition}

\begin{definition}[Nature]
	\label{def:nature}	
	Nature is an unpredictable decision maker that can interfere with the Robot's outcomes. It models uncertainty in the decision-making process.\index{Nature}
\end{definition}
