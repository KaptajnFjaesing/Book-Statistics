...
\begin{definition}[Sugeno Measure]
	...
	Let $(\Omega, \mathcal{F})$ be a measurable space (\dfref{def:measurable_space}) and $\operatorname{Bel}: \mathcal{F} \to [0, 1]$ a Sugeno measure\index{Sugeno measure} iff~\cite{shafer1987}
	\begin{enumerate}
