...
\begin{theorem}[Median Decision Rule]
	Assuming the cost function of definition \ref{def:linear_cost_function}
	\begin{equation}
		\begin{split}
...
\begin{theorem}[Expectation Decision Rule]
	...
	Assuming the cost function of definition \ref{def:quadratic_cost}
	\begin{equation}
		\begin{split}
